...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="container">
      ...
      @foreach ($primary_dependency['model']::where($field['primary_query'] ?? [])->get() as $connected_entity_entry)
      ...
      <div class="row">
          ...
          @foreach ($secondary_dependency['model']::where($field['secondary_query'] ?? [])->get() as $connected_entity_entry)
